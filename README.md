...
Open Isaacsim app and import the drone .USD files:
  1. Put the Iris_LiDAR folder from the repo into Pegasus Simulator repo Assets folder
  2. Run the Isaacsim
  3. Inside of the Isaacsim software you can use the Pegasus Simulator plugins to load desired Environment and load the Iris_LIDAR drone
